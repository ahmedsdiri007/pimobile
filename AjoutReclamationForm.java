...
public class AjoutReclamationForm extends BaseForm{
    ...
    public AjoutReclamationForm(Resources res){
       ...
       addTab(swipe, s1, res.getImage("reclamation.png"),"","",res);
...
addStringValue("Description" ,description);
 ...
 Button btnAjouter = new Button("Ajouter");  
        ...
        try {
            if( objet.getText().equals(" ")|| title.getText().equals(" ")|| description.getText().equals(" ")  ){
           Dialog.show("Veuillez verifier les donnees","", "Annuler", "OK");
               ...
               Reclamation r = new Reclamation(objet.getText(),title.getText(),description.getText());
