 ...
 */
public final class ListRestoForm extends BaseForm{
    Form current;
    
    public ListRestoForm(Resources res){
       ...
       swipe.setUIID("Container");
        ...
        RadioButton mesListes = RadioButton.createToggle("Ajout resto", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Autres", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Mes Restos", barGroup);
        ...
        addOrientationListener(e -> {
         ...
         ArrayList<resto>list = RestoService.getInstance().affichageResto();
   ...
   add(createLineSeparator(0xeeeee));
    ...
    private void addButton(Image img, resto rec, Resources res) {
  ...
  // ta.setUIID("NewsToLine");
   ...
   Label nomTxt = new Label("nomresto :"+rec.getNomresto(),"NewsToLine");
      Label nbplaceTxt = new Label("nbplace :"+rec.getNbplace(),"NewsToLine");
            Label budgetTxt = new Label("budget :"+rec.getBudget(),"NewsToLine");
  ...
  // cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(ta));
   ...
   lSupprimer.addPointerPressedListener(l  ->{
       ...
       if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")){
           ...
           if(RestoService.getInstance().deleteResto(rec.getId_resto())){
