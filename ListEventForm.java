...
import com.resto.service.ReservationService;
 ...
 */
public final class ListEventForm extends BaseForm{
    Form current;
    ...
    public ListEventForm(Resources res){
       ...
       addTab(swipe, s1, res.getImage("h2.png"),"","",res);
       ...
       swipe.setUIID("Container");
        ...
        RadioButton liste = RadioButton.createToggle("Ajout reservation", barGroup);
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          AjoutRestoForm a = new AjoutRestoForm(res);
            a.show();
            refreshTheme();
        });
        ...
        add(LayeredLayout.encloseIn(
         ...
         ArrayList<reservation_evenement>list = ReservationService.getInstance().getListProduits();
        System.out.println(list);
        
      for(reservation_evenement rec : list) {
   ...
   add(createLineSeparator(0xeeeee));
    ...
    private void addButton(Image img, reservation_evenement rec, Resources res) {
  ...
  // ta.setUIID("NewsToLine");
   ...
   Label nomTxt = new Label("nom :"+rec.getNom(),"NewsToLine");
      Label prenomTxt= new Label("prenom :"+rec.getPrenom(),"NewsToLine");
            Label mailTxt = new Label("mail :"+rec.getMail(),"NewsToLine");
                        //Label evtTxt = new Label("nom evenement :"+rec.getNameevent(),"NewsToLine");
  ...
  // cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(ta));
   ...
   lSupprimer.addPointerPressedListener(l  ->{
       ...
       if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")){
           ...
           /*if(ReservationService.getInstance().deleteResto(rec.getId())){
